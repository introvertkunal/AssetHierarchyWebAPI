...
namespace AssetHierarchyWebAPI.Hubs
{
    public class NotificationHub : Hub
    {
        ...
        //    {
        //        await Clients.Caller.SendAsync("ReceiveNotification", id, msg);  // Change: Send id and msg
        //    }

        //    if (missed.Any())
        //    {
        //        _notificationStore.MarkAsSeen(userName, missed.Last().Id);  // Keep this as a fallback
        //    }
        //    else
        //    {
        //        // From your previous fix: Still useful for catching up if no missed
